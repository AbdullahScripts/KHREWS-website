          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-500  font-medium">
                <li className="mb-4">
                  <Link
                    href="https://www.instagram.com/p/C4v5rI0r0X2/?igsh=YjN6dTdtcXFsdmM4"
                    className="hover:underline "
                  >
                    Instagram
                  </Link>
                ...
                <li>
                  <Link
                    href="https://youtube.com/@khrewsofficial?si=i0YqRRRz98Glvyhj"
                    className="hover:underline"
                  >
                    Youtube
                  </Link>
            ...
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                <li className="mb-4 hover:underline">+92 3340915037</li>
                <li className="hover:underline">Lahore,Punjab,Pakistan.</li>
              </ul>
            </div>
          </div>
        </div>
